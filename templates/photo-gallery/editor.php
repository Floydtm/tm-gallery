...
<script type="text/html" id="tm-pg-editor-tpl">
	...
	<div class="tm-pg_editor">
		<div class="tm-pg_editor_controls">
			<div class="tm-pg_editor_controls-empty-col"></div>
			...
			<div class="tm-pg_editor_controls-operations">
				<a href="#" class="tm-pg_btn tm-pg_btn-default tm-pg_editor_controls_cancel" data-message="<?php echo esc_attr__( 'Are you sure? All your changes will be lost.', 'tm_gallery' ) ?>">Cancel</a>
