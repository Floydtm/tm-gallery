...
function put_photoshop_file_info( $jpeg_header_data, $new_ps_file_info_array,
								  $Old_Exif_array, $Old_XMP_array, $Old_IRB_array ) {
	/*
	 * **************************************** */
	// PREPROCESSING
	...
	$new_Exif_array[0][270] = array(
		'Tag Name'	 => $GLOBALS['IFD_Tag_Definitions']['TIFF'][270]['Name'],
		'Tag Number' => 270,
		'Data Type'	 => 2,
	...
	$new_Exif_array[0][315] = array(
		'Tag Name'	 => $GLOBALS['IFD_Tag_Definitions']['TIFF'][315]['Name'],
		'Tag Number' => 315,
		'Data Type'	 => 2,
	...
	$new_Exif_array[0][33432] = array(
		'Tag Name'	 => $GLOBALS['IFD_Tag_Definitions']['TIFF'][33432]['Name'],
		'Tag Number' => 33432,
		'Data Type'	 => 2,
	...
	$new_Exif_array[0][306] = array(
		'Tag Name'	 => $GLOBALS['IFD_Tag_Definitions']['TIFF'][306]['Name'],
		'Tag Number' => 306,
		'Data Type'	 => 2,
	...
	$new_Exif_array[0][305] = array(
		'Tag Name'	 => $GLOBALS['IFD_Tag_Definitions']['TIFF'][305]['Name'],
		'Tag Number' => 305,
		'Data Type'	 => 2,
	...
	$Item['children'][0]['children'] = array( array(
			'tag'		 => 'rdf:li',
	...
	} elseif ( $new_ps_file_info_array['copyrightstatus'] == 'Public Domain' ) {
	...
	$Item['children'][0]['children'] = array(
		array(
			'tag'		 => 'rdf:li',
...
function find_XMP_Tag( $XMP_array, $tag ) {
	...
	foreach ( $XMP_array as $valkey => $val ) {
		...
		elseif ( strcasecmp( $val['tag'], $tag['tag'] ) == 0 ) {
...
$GLOBALS['Blank XMP Structure'] = array(
	0 =>
	array(
		'tag'		 => 'x:xmpmeta',
		'attributes' =>
