...
function get_Panasonic_Makernote( $Makernote_Tag, $EXIF_Array, $filehnd,
								  $Make_Field ) {
	...
	} elseif ( substr( $Makernote_Tag['Data'], 0, 12 ) == "Panasonic\x00\x00\x00" ) {
...
function get_Panasonic_Makernote_Html( $Makernote_tag, $filename ) {
	...
	} elseif ( $Makernote_tag['Makernote Type'] == 'Panasonic Empty Makernote' ) {
		// Do Nothing
		return '';
	} else {
