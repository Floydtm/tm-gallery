...
function put_EXIF_JPEG( $exif_data, $jpeg_header_data ) {
	...
	array_splice( $jpeg_header_data, $highest_APP + 1, 0, array(
		array(
			'SegType'	 => 0xE1,
			'SegName'	 => 'APP1',
...
function read_Multiple_IFDs( $filehnd, $Tiff_offset, $Byte_Align,
							 $Tag_Definitions_Name, $local_offsets = false, $read_next_ptr = true ) {
...
function read_IFD_universal( $filehnd, $Tiff_offset, $Byte_Align,
							 $Tag_Definitions_Name, $local_offsets = false, $read_next_ptr = true ) {
